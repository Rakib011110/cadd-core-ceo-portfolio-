...
const App = () => {
  return (
    <>
      {/* Embedding custom CSS within the component. In a Next.js project, you would typically use CSS Modules or a global CSS file. */}
      <style>{`
        ...
        .bg-ellipse {
            ...
            border-radius: 50%;
            background: radial-gradient(circle, rgba(144, 202, 249, 0.3) 0%, rgba(144, 202, 249, 0) 70%); /* Light blue transparent gradient */
      ...
      <div className="relative min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div
          className="absolute top-1/2 left-0 w-8 h-8 bg-blue-400 rounded-full animate-bounce"
          style={{ animationDelay: "0.5s" }}></div>
        <div
          className="absolute bottom-1/4 right-0 w-6 h-6 bg-purple-400 rounded-full animate-bounce"
          style={{ animationDelay: "1s" }}></div>

        {/* Container for the entire hero section */}
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left py-12 px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 text-gray-900 dark:text-white">
              Limitless learning at <br className="hidden sm:inline" /> your{" "}
              <span className="relative inline-block">
                fingertips
                <span className="absolute left-0 bottom-0 w-full h-3 bg-yellow-300 opacity-70 rounded-md -rotate-2 transform"></span>
              </span>
            </h1>
            ...
            <p className="mt-4 text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Engineer Hachnayen Ahmed is the Founder & CEO of CADD CEO,
              dedicated to empowering students with professional BIM modeling,
              structural analysis, design, and AutoCAD skills.
            </p>
          ...
          <div className="relative flex-1 flex justify-center lg:justify-end w-full lg:w-auto mt-12 lg:mt-0">
            {/* Background Blob/Shape behind the student */}
            ...
            {/* Main Student Image */}
            <img
              src="https://res.cloudinary.com/dalpf8iip/image/upload/v1751277732/Engr._Hachnayen_Ahmed-removebg-preview_cufiya.png" // Placeholder for the smiling student image
              alt="Smiling Student"
            ...
            {/* Floating Element 1: Angular Icon */}
            ...
            {/* Floating Element 4: "Congratulations" box (mimicking bottom-right yellow box) */}
            {/* <div className="absolute bottom-0 left-0 transform -translate-x-1/4 translate-y-1/4 z-10  dark:bg-yellow-700 text-white p-4 rounded-2xl shadow-xl transform rotate-3 hover:rotate-0 transition duration-300 flex items-center gap-2 floating-element-1">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 20 20"
            ...
            {/* Floating Element 5: Lightbulb icon - this will be placed over the student's head */}
